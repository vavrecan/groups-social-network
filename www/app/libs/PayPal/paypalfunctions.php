...
class PayPalFunctions
{
    ...
    */
    ...
    private $PAYPAL_DG_URL = "https://www.sandbox.paypal.com/incontext?token=";
    ...
    function __construct($sandbox, $user, $pass, $signature) {

        $this->SandboxFlag = $sandbox;
        if ($this->SandboxFlag == false)
        {
